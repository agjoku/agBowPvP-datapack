#execute rotated as @a[scores={job=3,spyglass_dropped=1..}] positioned 0.0 0.0 0.0 run summon armor_stand ^ ^ ^6 {CustomNameVisible:0b,NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["vector_stand"],CustomName:'{"text":"vector_stand"}'}
#execute as @a[scores={job=3,spyglass_dropped=1..}] anchored eyes at @s run summon arrow ^ ^ ^1 {NoGravity:1b,Glowing:1b,Tags:["vector_arrows"],CustomName:'{"text":"vector_arrow"}'}
...
#scoreboard players set @a[scores={spyglass_dropped=1..}] spyglass_dropped 0
...
scoreboard players add @a[tag=reload] reloadtime 1
tag @a[scores={reloadtime=200..}] remove reload
...
scoreboard players set @a[scores={reloadtime=200..}] reloadtime 0

tag @e[tag=vector_arrows] add vector_arrow
data modify entity @e[limit=1,tag=vector_arrow] Motion set from entity @e[name="vector_stand",limit=1] Pos
#data modify entity @e[limit=1,tag=vector_arrow] Motion merge from entity @e[name="vector_stand",limit=1] Pos
#data modify entity @e[limit=1,tag=vector_arrow] Motion merge from entity @e[name="vector_stand",limit=1] Pos
#data modify entity @e[limit=1,tag=vector_arrow] Motion merge from entity @e[name="vector_stand",limit=1] Pos
tag @e[tag=vector_arrows] remove vector_arrows
tag @e[tag=vector_arrow] remove vector_arrow
...
kill @e[scores={arrow_deathtime=60..}]